...
async def start_command(client: Client, message: Message):
    ...
    developer_button = InlineKeyboardButton("ᴅᴇᴠᴇʟᴏᴘᴇʀ ⚡️", url="https://t.me/torch_bearr")
    repo69 = InlineKeyboardButton("ʀᴇᴘᴏ 🌐", url="https://github.com/AGENTxMAX/Terabox-Downloader-Bot")
...
async def handle_message(client: Client, message: Message):
    ...
    final_url = f"https://violent-tahr-agentxmax-0cd72c23.koyeb.app/?url={encoded_url}"
    ...
    caption = (
        ...
        "[ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴊᴇᴛ-ᴍɪʀʀᴏʀ ❤️🚀](https://t.me/AgentxMax)"
    )
